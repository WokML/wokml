...
module GeneratedParser.Wok.Layout where
...
layoutWords =
  [ ( TokSymbol "let" 40
    , LayoutDelimiters (TokSymbol ";" 9) (Just (TokSymbol "{" 59)) (Just (TokSymbol "}" 61))
    )
  , ( TokSymbol "where" 57
    , LayoutDelimiters (TokSymbol ";" 9) (Just (TokSymbol "{" 59)) (Just (TokSymbol "}" 61))
    )
...
layoutStopWords = [TokSymbol "in" 37]
...
layoutSep   = List.nub $ TokSymbol ";" 9 : map (delimSep . snd) layoutWords
...
resolveLayout topLayout =
  ...
  topDelim = LayoutDelimiters (TokSymbol ";" 9) Nothing Nothing
